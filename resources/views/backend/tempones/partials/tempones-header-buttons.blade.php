<!--Action Button-->
@if( Active::checkUriPattern( 'admin/tempones' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.tempones.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.tempones.all' ) }}
            </a>
        </li>
        @permission( 'create-tempone' )
            <li>
                <a href="{{ route( 'admin.tempones.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.tempones.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
