<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sampletwos' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.sampletwos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sampletwos.all' ) }}
            </a>
        </li>
        @permission( 'create-sampletwo' )
            <li>
                <a href="{{ route( 'admin.sampletwos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sampletwos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
