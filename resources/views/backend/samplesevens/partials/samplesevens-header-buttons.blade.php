<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplesevens' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplesevens.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplesevens.all' ) }}
            </a>
        </li>
        @permission( 'create-sampleseven' )
            <li>
                <a href="{{ route( 'admin.samplesevens.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplesevens.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
