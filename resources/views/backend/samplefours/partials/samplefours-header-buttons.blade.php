<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplefours' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplefours.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplefours.all' ) }}
            </a>
        </li>
        @permission( 'create-samplefour' )
            <li>
                <a href="{{ route( 'admin.samplefours.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplefours.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
