<!--Action Button-->
@if( Active::checkUriPattern( 'admin/visions' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.visions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.visions.all' ) }}
            </a>
        </li>
        @permission( 'create-vision' )
            <li>
                <a href="{{ route( 'admin.visions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.visions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
