<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sampleones' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.sampleones.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sampleones.all' ) }}
            </a>
        </li>
        @permission( 'create-sampleone' )
            <li>
                <a href="{{ route( 'admin.sampleones.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sampleones.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
