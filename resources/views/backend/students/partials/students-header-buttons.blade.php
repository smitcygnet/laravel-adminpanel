<!--Action Button-->
@if( Active::checkUriPattern( 'admin/students' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.students.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.students.all' ) }}
            </a>
        </li>
        @permission( 'create-student' )
            <li>
                <a href="{{ route( 'admin.students.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.students.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
