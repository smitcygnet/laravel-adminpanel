<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplesevennews' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplesevennews.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplesevennews.all' ) }}
            </a>
        </li>
        @permission( 'create-samplesevennew' )
            <li>
                <a href="{{ route( 'admin.samplesevennews.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplesevennews.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
