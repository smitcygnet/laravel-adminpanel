<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sampletemps' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.sampletemps.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sampletemps.all' ) }}
            </a>
        </li>
        @permission( 'create-sampletemp' )
            <li>
                <a href="{{ route( 'admin.sampletemps.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sampletemps.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
