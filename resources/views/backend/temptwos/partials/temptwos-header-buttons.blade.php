<!--Action Button-->
@if( Active::checkUriPattern( 'admin/temptwos' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.temptwos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.temptwos.all' ) }}
            </a>
        </li>
        @permission( 'create-temptwo' )
            <li>
                <a href="{{ route( 'admin.temptwos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.temptwos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
