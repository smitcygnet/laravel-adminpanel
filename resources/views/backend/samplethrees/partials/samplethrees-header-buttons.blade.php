<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplethrees' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplethrees.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplethrees.all' ) }}
            </a>
        </li>
        @permission( 'create-samplethree' )
            <li>
                <a href="{{ route( 'admin.samplethrees.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplethrees.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
