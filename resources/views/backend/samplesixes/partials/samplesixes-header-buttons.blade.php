<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplesixes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplesixes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplesixes.all' ) }}
            </a>
        </li>
        @permission( 'create-samplesix' )
            <li>
                <a href="{{ route( 'admin.samplesixes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplesixes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
