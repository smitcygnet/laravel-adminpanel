<!--Action Button-->
@if( Active::checkUriPattern( 'admin/lives' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.lives.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.lives.all' ) }}
            </a>
        </li>
        @permission( 'create-life' )
            <li>
                <a href="{{ route( 'admin.lives.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.lives.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
