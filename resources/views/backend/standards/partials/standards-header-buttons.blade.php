<!--Action Button-->
@if( Active::checkUriPattern( 'admin/standards' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.standards.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.standards.all' ) }}
            </a>
        </li>
        @permission( 'create-standard' )
            <li>
                <a href="{{ route( 'admin.standards.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.standards.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
