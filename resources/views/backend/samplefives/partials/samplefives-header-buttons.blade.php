<!--Action Button-->
@if( Active::checkUriPattern( 'admin/samplefives' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.samplefives.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.samplefives.all' ) }}
            </a>
        </li>
        @permission( 'create-samplefive' )
            <li>
                <a href="{{ route( 'admin.samplefives.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.samplefives.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
