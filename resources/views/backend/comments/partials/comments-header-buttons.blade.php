<!--Action Button-->
@if( Active::checkUriPattern( 'admin/comments' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.comments.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.comments.all' ) }}
            </a>
        </li>
        @permission( 'create-comment' )
            <li>
                <a href="{{ route( 'admin.comments.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.comments.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
