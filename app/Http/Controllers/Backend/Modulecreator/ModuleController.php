...
//use Library\Modulecreator\Generator\Src\Repositories\ModuleRepository;
...
class ModuleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.modulecreator.index');
    }
    /**
     * Display a listing of the resource.
     *
    ...
    {
        $datatype  = ['string'   =>'String', 'integer'  =>'Integer', 'decimal'  =>'Decimal',
                      'enum'     =>'Enum', 'text' =>'Text','datetime' =>'dateTime',];
        $inputType = ['textbox'   =>'Textbox', 'textarea'  =>'Textarea', 'select'    =>'Select',
                      'radio'     =>'Radio', 'checkbox'  =>'Checkbox','datetime'  =>'DateTime',
                      'file'      =>'File',];
    ...
    $fieldValidation = ['Optional','Required','Required & Unique'];
        ...
        ->with('field_validation', $fieldValidation)
    ...
    public function store(Request $request)
    {
     // Upload DB csv file for the Module
        ...
        $input['model_edit']     = $collection['model_edit'];
        $input['model_create']   = $collection['model_create'];
        $input['model_delete']   = $collection['model_delete'];
        $input['api_edit']       = $collection['api_edit'];
        $input['api_create']     = $collection['api_create'];
        $input['api_delete']     = $collection['api_delete'];
        $input['event']          = []; //$collection['event'];
