...
namespace App\Http\Requests\Backend\Tempmodule;

use Illuminate\Foundation\Http\FormRequest;

class StoreTempmoduleRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('store-tempmodule');
    }
    ...
    public function rules()
    {
        ...
        'first_name' => 'required|max:191',
			...
			'publisheddate' => 'required|max:191',
