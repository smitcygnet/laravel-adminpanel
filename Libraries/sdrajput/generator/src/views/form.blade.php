 ...
 <!-- Database File -->
    ...
    <div class="schema-header-div">
        <div class="form-group clearfix">
            ...
            {{ Form::label('event[]', trans('generator::labels.modules.form.field_type'), ['class' => 'control-label']) }}
            </div><!--col-lg-10-->
            <div class="col-lg-2">
             {{ Form::label('event[]', trans('generator::labels.modules.form.field_key'), ['class' => 'control-label']) }}
            </div><!--col-lg-10-->
            <div class="col-lg-2">
        ...
        <div class="form-group schema clearfix">
            ...
            <div class="col-lg-2">
                <?php
                    ...
                    $fieldValidation = ['Optional','Required','Required & Unique'];
                ?>
                {{Form::select('field_type[]',$fieldType, null,['class' => 'form-control select2 status box-size','placeholder' => trans('generator::labels.modules.form.field_type'), 'style' => 'width:100%']) }}
            </div><!--col-lg-10-->
            <div class="col-lg-2">
                {{ Form::text('field_key[]', null, ['class' => 'form-control box-size', 'placeholder' => trans('generator::labels.modules.form.field_key'), 'style' => 'width:100%']) }}
            </div><!--col-lg-10-->
            <div class="col-lg-2">
                {{ Form::text('field_label[]', null, ['class' => 'form-control box-size', 'placeholder' => trans('generator::labels.modules.form.field_label'), 'style' => 'width:100%']) }}
            </div><!--col-lg-10-->
            <div class="col-lg-2">
                {{Form::select('field_validation[]',$fieldValidation, null,['class' => 'form-control select2 status box-size','placeholder' => trans('generator::labels.modules.form.validations'), 'style' => 'width:100%']) }}
            </div><!--col-lg-10-->
